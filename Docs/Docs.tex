...
\inputpython{../Source/ArithmeticSumGray.py}{15}{41}
...
\subsection{Kod źródłowy programu}
\inputpython{../Source/ArithmeticSumGray.py}{44}{74}

\section{Mnożenie obrazu przez zadaną liczbę}
\subsection{Opis}
Mnożenie macierzy obrazu prze liczbę to mnożenie każdego z elementów macierzy przez tą liczbę. 

\begin{figure}[H]
	\caption{Przed uruchomieniem algorytmu (lewy obraz), po pomnożeniu przez wartość 30 (środkowy obraz), po normalizacji (prawy obraz)}
	\includegraphics[width=5cm, height=5cm]{man-unmodified.jpg}
	\includegraphics[width=5cm, height=5cm]{2/multiply-gray-const-30.png}
	\includegraphics[width=5cm, height=5cm]{2/multiply-gray-const-30-norm.png}
\end{figure}
\begin{figure}[H]
	\caption{Przed uruchomieniem algorytmu (lewy obraz), po pomnożeniu przez wartość 300 (środkowy obraz), po normalizacji (prawy obraz)}
	\includegraphics[width=5cm, height=5cm]{man-unmodified.jpg}
	\includegraphics[width=5cm, height=5cm]{2/multiply-gray-const-300.png}
	\includegraphics[width=5cm, height=5cm]{2/multiply-gray-const-300-norm.png}
\end{figure}

\subsection{Kod źródłowy programu}
\inputpython{../Source/ArithmeticSumGray.py}{77}{102}

\section{Mnożenie obrazu przez inny obraz}
\subsection{Opis}
Przebiega analogicznie jak przez stałą, ale z tą różnicą że każdą komórkę macierzy mnożymy przez odpowiadającą 
jej komórkę w drugiej macierzy obrazu. 
...
\subsection{Kod źródłowy programu}
\inputpython{../Source/ArithmeticSumGray.py}{105}{129}
