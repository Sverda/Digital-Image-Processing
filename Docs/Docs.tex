...
\chapter{Filtrowanie wygładzające liniowe i nieliniowe}
	...
	\section{Filtr Kuwahary}
		\subsection{Opis}
			Filtr wygładzający Kuwahary polega na wybraniu najmniejszej wariancji z czterech regionów, które składają się na maskę. Każdy region nachodzi na krawędź dwóch sąsiednich. 
			\begin{figure}[H]
				\caption{Przykład maski z zaznaczonymi regionami}
				\includegraphics[width=16cm, height=7cm]{/overview/kuwahara-matrix.png}
			\end{figure}
			\begin{figure}[H]
				\caption{Obraz niezmieniony (lewy, górny), po zastosowaniu filtru z maską 3x3 (prawy, górny), z maską 5x5 (lewy, dolny), z maską 27x27 (prawy, dolny)}
				\includegraphics[width=7cm, height=7cm]{man-unmodified.jpg}
				\includegraphics[width=7cm, height=7cm]{man-filter-kuwahara3x3.png}
				\includegraphics[width=7cm, height=7cm]{man-filter-kuwahara5x5.png}
				\includegraphics[width=7cm, height=7cm]{man-filter-kuwahara27x27.png}
			\end{figure}
		\subsection{Kod źródłowy algorytmu}
			\inputpython{../Source/Filters.py}{135}{168}
